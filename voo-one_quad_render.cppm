...
namespace voo {
  ...
  public:
    refreshing_oqr(jute::view shader, const voo::device_and_queue * dq, const vee::pipeline_layout::type pl)
      : refreshing_oqr { shader, dq->physical_device(), dq->render_pass(), pl } {}
    ...
    refreshing_oqr(jute::heap shader, vee::physical_device pd, vee::render_pass::type rp, const vee::pipeline_layout::type pl,
                    blends_t blends = { vee::colour_blend_classic() })
      : refreshing_oqr(*(shader + ".vert.spv"), *(shader + ".frag.spv"), pd, rp, pl, blends) {}

    refreshing_oqr(jute::view shader, vee::physical_device pd, vee::render_pass::type rp, const vee::pipeline_layout::type pl,
                    blends_t blends = { vee::colour_blend_classic() })
      : refreshing_oqr(jute::heap { shader }, pd, rp, pl, blends) {}
